...
const VALID_CELL_CODES = (() => {
  ...
  add("ZSN", 15); add("ZV", 15); add("ZVA", 15); add("ZVB", 15); add("ZPA", 15); add("ZPB", 15);
  add("ZPC", 15); add("ZPD", 15); add("ZT", 15); add("ZSA", 15);
  add("ZSB", 15); add("ZC", 15); add("ZTC", 15); add("ZSC", 15);
  // Codes with no numeric suffix
  codes.push("THECHAMPS", "UTS");
  return codes;
})();
